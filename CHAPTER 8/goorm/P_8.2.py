...
#p8_2
def checkNumber(n, id, max) : # 0 or 1 부분에서 0과 1 중 하나를 선택하시오. 
	if n == None : print('None', n.data, id); return    1
	if id > max : print('False', n.data, id); return    0
	if n.left != None and checkNumber(n.left, id * 2, max)==0 : print('False', n.data, id); return 0
	if n.right!= None and checkNumber(n.right, id* 2+1, max)==0: print('False', n.data, id); return 0
	print('True', n.data, id); return 1
...
def testP8_2() :
    ...
    is_complete_binary_tree(tree.root)
